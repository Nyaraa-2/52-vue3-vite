    ...
    <div class="mx-4 p-4">
      <div class="flex items-center">
        <div class="flex items-center text-red-600 relative">
          <div
            class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-red-600"
          >
            <svg
        ...
        <div
          class="flex-auto border-t-2 transition duration-500 ease-in-out border-red-600"
        ></div>
        <div class="flex items-center text-white relative">
          <div
            class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 bg-red-600 border-red-600"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="100%"
    ...
    <div class="mt-8 p-4">
      ...
      <div class="flex p-2 mt-4">
        ...
        <div class="flex-auto flex flex-row-reverse">
          <button
            class="text-base ml-2 hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer hover:bg-red-600 bg-red-600 text-red-100 border duration-200 ease-in-out border-red-600 transition"
          >
            Next
          </button>
          <button
